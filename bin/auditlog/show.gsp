...
<html>
    ...
    <body>
        ...
        <div id="show-auditlog" class="content scaffold-show" role="main">
            ...
            <f:display bean="auditlog" />
            <g:form resource="${this.auditlog}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.auditlog}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
